						...
						if (random.nextInt(1000) < CHANCE_OF_CASTLE) {
							if(!DungeonMaze.isConstantRoom(world.getName(), source.getX(), source.getZ(), x, y, z)) {
								...
								for(int xx = 0; xx < 7; xx++) {
									source.getBlock(x + xx, y + yfloorRelative + 3, z).setTypeId(98);
									source.getBlock(x + xx, y + yfloorRelative + 3, z + 7).setTypeId(98);
								}
								for(int zz = 0; zz < 7; zz++) {
									source.getBlock(x, y + yfloorRelative + 3, z + zz).setTypeId(98);
									source.getBlock(x + 7, y + yfloorRelative + 3, z + zz).setTypeId(98);
								}
								source.getBlock(x, y + yfloorRelative + 4, z + 1).setTypeId(44);
								source.getBlock(x, y + yfloorRelative + 4, z + 1).setData((byte) 5);
								source.getBlock(x, y + yfloorRelative + 4, z + 3).setTypeId(44);
								source.getBlock(x, y + yfloorRelative + 4, z + 3).setData((byte) 5);
								source.getBlock(x, y + yfloorRelative + 4, z + 5).setTypeId(44);
								source.getBlock(x, y + yfloorRelative + 4, z + 5).setData((byte) 5);
								...
								source.getBlock(x + 1, y + yfloorRelative + 4, z).setTypeId(44);
								source.getBlock(x + 1, y + yfloorRelative + 4, z).setData((byte) 5);
								source.getBlock(x + 3, y + yfloorRelative + 4, z).setTypeId(44);
								source.getBlock(x + 3, y + yfloorRelative + 4, z).setData((byte) 5);
								source.getBlock(x + 5, y + yfloorRelative + 4, z).setTypeId(44);
								source.getBlock(x + 5, y + yfloorRelative + 4, z).setData((byte) 5);
								...
								source.getBlock(x, y + yfloorRelative + 4, z + 6).setTypeId(30);
