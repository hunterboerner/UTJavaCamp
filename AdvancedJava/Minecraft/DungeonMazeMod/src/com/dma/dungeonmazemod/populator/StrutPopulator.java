								...
								if (random.nextInt(100) < CHANCE_OF_STRUT) {
									...
									if(source.getBlock(x + 2, ystrutbar, z).getTypeId() == 0) {
										...
										for(int xx = 1; xx < 7; xx++) {
											source.getBlock(x + xx, ystrutbar, z).setTypeId(5);
										}
										// Generate strut poles
										for(int yy = yfloor + 1; yy < ystrutbar; yy++) {
											source.getBlock(x+1, yy, z).setTypeId(85);
											source.getBlock(x+6, yy, z).setTypeId(85);
										}
									}
								...
								if (random.nextInt(100) < CHANCE_OF_STRUT) {
									...
									if(source.getBlock(x, ystrutbar, z + 2).getTypeId() == 0) {
										...
										for(int zz = 1; zz < 7; zz++) {
											source.getBlock(x, ystrutbar, z + zz).setTypeId(5);
										}
										// Generate strut poles
										for(int yy = yfloor + 1; yy < ystrutbar; yy++) {
											source.getBlock(x, yy, z+1).setTypeId(85);
											source.getBlock(x, yy, z+6).setTypeId(85);
										}
									}
