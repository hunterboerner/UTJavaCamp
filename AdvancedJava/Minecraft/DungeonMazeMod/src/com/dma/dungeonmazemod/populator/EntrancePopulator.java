				...
				for (int z=0; z < 16; z+=8) {
					...
					if(!DungeonMaze.isConstantRoom(world.getName(), source, x, y, z)) {
						if (random.nextInt(1000) < CHANCE_OF_ENTRANCE) {
							...
							case 0:
								// Get ground height
								for(yground = 100; source.getBlock(x, yground, z + 3).getType() == Material.AIR; yground--);
								...
								//   corners
								for(int yy = yground + 1; yy < yground + 4; yy++) {
									source.getBlock(x, yy, z).setTypeId(98);
									source.getBlock(x, yy, z + 7).setTypeId(98);
									source.getBlock(x + 7, yy, z).setTypeId(98);
								...
								for(int xx = 1; xx < 7; xx++) {
									for(int yy = yground + 1; yy < yground + 4; yy++) {
										source.getBlock(x + xx, yy, z).setTypeId(4);
										source.getBlock(x + xx, yy, z + 7).setTypeId(4);
										source.getBlock(x, yy, z + xx).setTypeId(4);
								...
								//   gate
								source.getBlock(x, yground + 1, z + 2).setTypeId(85);
								source.getBlock(x, yground + 1, z + 5).setTypeId(85);
								source.getBlock(x, yground + 2, z + 2).setTypeId(85);
								source.getBlock(x, yground + 2, z + 5).setTypeId(85);
								source.getBlock(x, yground + 1, z + 3).setTypeId(0);
								source.getBlock(x, yground + 1, z + 4).setTypeId(0);
								source.getBlock(x, yground + 2, z + 3).setTypeId(0);
								source.getBlock(x, yground + 2, z + 4).setTypeId(0);
								for(int zz = 2; zz < 6; zz++) {
									source.getBlock(x, yground + 3, z + zz).setTypeId(5);
								}
							...
							case 3:
								...
								//   corners
								source.getBlock(x, yground + 1, z).setTypeId(50);
								source.getBlock(x, yground + 1, z + 7).setTypeId(50);
								source.getBlock(x + 7, yground + 1, z).setTypeId(50);
